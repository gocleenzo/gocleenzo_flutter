...
class AdminPromosScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('AdminPromosScreen', style: GoogleFonts.nunito(fontWeight: FontWeight.w900, color: AppColors.navy)),
        backgroundColor: Colors.transparent, elevation: 0,
      ),
      body: Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
        Icon(Icons.construction, size: 48, color: AppColors.cyanLight),
        const SizedBox(height: 12),
        Text('AdminPromosScreen', style: GoogleFonts.nunito(fontWeight: FontWeight.w900, fontSize: 18, color: AppColors.navy)),
